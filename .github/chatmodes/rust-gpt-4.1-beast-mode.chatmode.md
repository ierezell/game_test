...
model: GPT-4.1
tools: ['changes', 'edit', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'edit/editNotebook', 'edit/newJupyterNotebook', 'extensions', 'fetch', 'githubRepo', 'new/runVscodeCommand', 'problems', 'runCommands', 'runCommands/getTerminalOutput', 'runCommands/runInTerminal', 'runCommands/terminalLastCommand', 'runCommands/terminalSelection', 'runTests', 'search', 'search/codebase', 'search/fileSearch', 'search/listDirectory', 'search/readFile', 'search/searchResults', 'search/textSearch', 'testFailure', 'todos','vscodeAPI', 'usages']
---
