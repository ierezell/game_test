...
use crate::scene::{color_from_id, PlayerPhysicsBundle};
...
pub fn spawn_classic_ai_bot(commands: &mut Commands, bot_id: u32, position: Vec3) -> Entity {
    ...
    // Add weapon holder to bot
    crate::weapons::add_weapon_holder(&mut *commands, bot_entity);

    // Add stamina system to bot
    crate::stamina::add_stamina_to_player(&mut *commands, bot_entity);
